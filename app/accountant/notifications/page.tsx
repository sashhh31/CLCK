              ...
              <div className="flex-1">
                <div className="flex justify-between">
                  <p className="text-sm mt-3">
                    {notification.type === "new_user" && <span className="text-black">New user </span>}
                    <span className="font-medium">{notification.user.name}</span>{" "}
                    <span className="text-black">{notification.action}</span>
                  </p>
                  <span className="text-sm text-black">{notification.time}</span>
                </div>
              </div>
            </div>
          ))}
