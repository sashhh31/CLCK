...
export default function BudgetingAndForecastingPage() {
  const uploads = [
    {
      id: "01",
  ...
  return (
    <div className="p-8">
      ...
      <h1 className="text-3xl font-bold mb-2">Budgeting And Forecasting</h1>
                ...
                <tr key={upload.id}>
                  ...
                  <td className="text-sm underline text-center">
                    <div className="flex items-center justify-center space-x-2">
                      ...
                      <Link href={`./budgeting-and-forecasting/${upload.id}`}>
