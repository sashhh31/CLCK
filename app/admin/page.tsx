...
export default function DashboardPage() {
       ...
       <div className="grid-rows-1 md:grid-rows-2 lg:grid-rows-4">
        <div className="flex gap-3 mb-4 ">
          ...
          <div className="bg-gray-100 w-60 h-52 rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <h3 className="text-sm text-black mt-11">Total Users Added</h3>
          ...
          <div className="bg-gray-100 w-60 h-52 rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <h3 className="text-sm text-black mt-11">Total Downloads</h3>
            <div className="flex items-baseline justify-between ">
        ...
        <div className="flex gap-3">
          ...
          <div className="bg-gray-100 w-60 h-52  rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <h3 className="text-sm text-black mt-11">Total Documents Added</h3>
            <div className="flex items-baseline justify-between ">
          ...
          <div className="bg-gray-100 w-60 h-52  rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <h3 className="text-sm text-black mt-11">Total Emails sent</h3>
            <div className="flex items-baseline justify-between">
        ...
        <div className="bg-gray-100 h-[430px] w-[700px] rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex items-center mb-4">
              <div className="flex items-center mr-4">
                ...
                <span className="text-sm text-black">Uploaded</span>
              </div>
              <div className="flex items-center">
                <div className="h-3 w-3 rounded-full bg-yellow-500 mr-2"></div>
                <span className="text-sm text-black">Downloaded</span>
              </div>
            </div>
  ...
  <div className="flex justify-between items-center mb-4">
    <h2 className="text-xl font-montserrat font-medium text-black">Subscription Earnings</h2>
