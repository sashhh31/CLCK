...
export default function SubscriptionsPage() {
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-black mb-8">Total Subscription added : 120</p>
                    ...
                    <div className="flex items-center">
                      {subscription.addedBy.avatar ? (
                        ...
                        <div className="h-8 w-8 rounded-full bg-gray-200 flex items-center justify-center mr-3">
                          <span className="text-black">{subscription.addedBy.name.charAt(0)}</span>
                        </div>
                      )}
                      <div>
                        <p className="text-sm font-medium">{subscription.addedBy.name}</p>
                        <p className="text-xs text-black">{subscription.addedBy.email}</p>
                      </div>
                    </div>
                  </td>
