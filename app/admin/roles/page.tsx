      ...
      <div className="bg-white rounded-3xl shadow-sm p-8 border">
        <div className="flex justify-between mb-6">
          <div className="relative w-full max-w-md">
            ...
            <Search className="absolute right-6 top-2.5 h-5 w-5 text-black" />
          </div>
          <button 
          ...
          <div className="text-center">
            ...
            <div className="flex justify-start gap-4 mt-8">
              <button 
                ...
                className="px-8 py-2 bg-gray-200 text-black rounded-full font-medium"
              >
                Cancel
              </button>
              <button 
              ...
              <div className="relative ">
                {selectedUser.avatar ? (
                  ...
                  <div className="h-32 w-32 rounded-full bg-gray-200 flex items-center justify-center">
                    <span className="text-black text-4xl">{selectedUser.name.charAt(0)}</span>
                  </div>
                )}
                <div className="absolute top-0 right-0 bg-[#2A3356] p-2 rounded-full">
                  <Edit className="h-5 w-5  text-white" />
