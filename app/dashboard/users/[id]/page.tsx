              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">Sr No</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">File Name</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">File type</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">Downloaded On</th>
                ...
                <tbody className="divide-y">
                  {subscriptions.map((subscription) => (
                    <tr key={subscription.id}>
                      ...
                      <td className="px-4 py-4 text-sm">
                        <span className={`px-2 py-1 rounded-full text-xs ${subscription.status === "Current" ? "bg-blue-100 text-blue-800" : "bg-yellow-100 text-yellow-800"}`}>
                          {subscription.status}
                        </span>
                      </td>
                    </tr>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50">
                    ...
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">Attached Document</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">Sent On</th>
                  </tr>
                </thead>
                <tbody className="divide-y">
                  {emails.map((email) => (
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50">
                    ...
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">File Name</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">File type</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">Uploaded On</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-500">Action</th>
                  </tr>
                </thead>
                <tbody className="divide-y">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex flex-col items-center mb-6">
              ...
              <p className="text-sm text-gray-500">admin@AK.Trading.com</p>
            </div>

            <div className="text-sm text-gray-500 mb-4">Added On : Apr 10, 2024</div>

            <div className="space-y-2">
              <button 
                className={`flex items-center justify-between w-full p-3 rounded-md ${activeTab === "downloads" ? "bg-blue-50 text-blue-600" : "hover:bg-gray-50"}`}
              ...
              <button 
                className={`flex items-center justify-between w-full p-3 rounded-md ${activeTab === "subscriptions" ? "bg-blue-50 text-blue-600" : "hover:bg-gray-50"}`}
          ...
          <div className="bg-white rounded-lg w-full max-w-md mx-4">
            <div className="p-6">
              ...
              <button className="flex items-center w-full p-3 border border-gray-300 rounded-full mb-6">
                ...
                <span className="text-gray-500">Attach document</span>
              </button>
