        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div 
              ...
              className="bg-primary rounded-2xl p-6 flex flex-col gap-4 h-[180px] text-white hover:border hover:border-secondary transition-all duration-200"
            >
              {service.icon && (
              ...
              {service.serviceDetailsPage && service.serviceDetailsPage.length > 0 ? (
                <Link
                  ...
                  className="text-xs font-medium text-secondary hover:text-white transition-colors duration-200 inline-flex items-center gap-1 mt-auto"
                >
